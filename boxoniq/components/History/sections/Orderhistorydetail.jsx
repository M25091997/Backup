...
const Orderhistorydetail = () => {
        ...
        if (confirm("Do you really want to cancel!.") == true) {
                    ...
                    try {
                        const response = await axios({
                            method: "POST",
                            url: "https://cms.cybertizeweb.com/boxoniq-crm/api/app/next/cancel-order-web-bo.php",
                            data: send_data
                        });
    ...
    const getBlogDetail = async (orderid) => {
        ...
        try {
            const response = await axios({
                method: "POST",
                url: "https://cms.cybertizeweb.com/boxoniq-crm/api/app/next/get-order-details-web-bo.php",
                data: send_data
            });
