...
import { getAgencyBySlug, getInitialSignup } from '../../redux/actions';
...
import { generatePublicUrl, base_url, api } from '../../helpers/urlConfig';
 ...
 const Institute = () => {
    ...
    const agencyData = useSelector(state => state.getAgencyData);

    const [name, setName] = useState(agencyData.agency.name);
    ...
    useEffect( async () => {
        ...
        await dispatch(getAgencyBySlug(tutor_id));

        agencyData.agency && agencyData.agency.length > 0 ? setName(agencyData.agency[0].name) : setName(userData.user[0].name)
        agencyData.agency && agencyData.agency.length > 0 ? setEmail(agencyData.agency[0].email) : setEmail(userData.user[0].email)
        agencyData.agency && agencyData.agency.length > 0 ? setMobile(agencyData.agency[0].mobile) : setMobile(userData.user[0].mobile)
        agencyData.agency && agencyData.agency.length > 0 ? setPassword(agencyData.agency[0].password) : setPassword(userData.user[0].password)
        agencyData.agency && agencyData.agency.length > 0 ? setDescription(agencyData.agency[0].description) : setDescription(userData.user[0].description)
    ...
    const userProfile = (e) => {
        ...
        // return false;
        axios.post('https://cybertizeweb.com/cms/studyfocus/cybertechMedia/api/new-study-api/update/update-profile-agency.php', formData)
    ...
    const userSubject = (e) => {
        ...
        // console.log(formData);
        // return false;
        axios.post('https://studyfocus.in/cybertechMedia/api/new-study-api/update/update-subject.php', formData)
            .then(function (response) {
                //handle success
                console.log(response)
                console.log("success")
    ...
    const userDescription = (e) => {
        ...
        axios.post('https://studyfocus.in/cybertechMedia/api/new-study-api/update/update-description.php', formData)
            .then(function (response) {
                //handle success
                console.log(response)
                console.log("success")
    ...
    const userQualification = (e) => {
        ...
        axios.post('https://studyfocus.in/cybertechMedia/api/new-study-api/update/add-qualification.php', formData)
            .then(function (response) {
                //handle success
                console.log(response)
                console.log("success")
    ...
    const renderStep1 = () => {
        return (
            <>
                {
                    agencyData.agency && agencyData.agency.length > 0 ?
                        agencyData.agency.map(agency =>
                            <>
                                <div className="sign__input-wrapper mb-25">
                                    <center>
                                        <div style={{
                                            ...
                                            backgroundImage: `url(${generatePublicUrl('newagency/' + agency.profile)})`
                                        }}>
                        ...
                        <div className="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                            ...
                            <div className="sign__wrapper white-bg">
                                ...
                                <div className="sign__form" method='POST'>
                                    ...
                                    {step4 == '1' ? 
                                        tutorData.qual && tutorData.qual.map(qua =>
