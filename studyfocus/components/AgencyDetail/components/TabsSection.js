                            ...
                            <div className="tab-content" id="courseTabContent">
                                <div className="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                    <div className="course__description">
                                        ...
                                        <p><b>Description:</b> {agency.descripion}</p><hr></hr>
                                        <p><b>Platform:</b> {agency.platform}</p><hr></hr>
                                        <p><b>Medium:</b> {agency.medium}</p><hr></hr>
                                        <p><b>Board:</b> {agency.board}</p><hr></hr>
                                        <div className="course__tag-2 mb-35 mt-35">
                                            <i className="fal fa-tag"></i>

                                            <a href="#">{agency.subjects}</a>
                                ...
                                <div className="tab-pane fade" id="member" role="tabpanel" aria-labelledby="member-tab">
                                    <div className="course__member mb-45">
                                        {
                                            singleAgency.singleagency.rel_tutor && singleAgency.singleagency.rel_tutor.length > 0 ? singleAgency.singleagency.rel_tutor.map(tut =>
                                                <>
