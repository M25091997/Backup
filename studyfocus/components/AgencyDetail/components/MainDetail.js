...
export const MainDetail = () => {
    ...
    const handleRating = () => {
        ...
        var agency_id = singleAgency.singleagency.agency[0].id;
        // alert(agency_id);
        // return;
        ...
        if (student.student_id == "") {
            ...
            const ratingData = {
                rating: rating, review: review, user_id: user_id, agency_id: agency_id
            }
            axios.post(`${api}/update/update-agency-rating.php`, ratingData)
    ...
    const renderSubject = () => {
        renderSubArray(singleAgency.singleagency.agency[0].subjects).length > 0 ?
            renderSubArray(singleAgency.singleagency.agency[0].subjects).slice(0, 2).map(i =>
                ...
                <div className="col-xxl-12">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-9 col-xl-9">
                                    ...
                                    <p style={{ marginTop: '5px' }}>
                                        ...
                                        {singleAgency.singleagency.city}, {singleAgency.singleagency.state}
                                ...
                                <div className="col-md-9 col-xl-9">
...

                                    {
                                        singleAgency.loading ? <>
                                            ...
                                            singleAgency.singleagency && singleAgency.singleagency.agency[0].subjects.length > 0 ?
                                                renderSubArray(singleAgency.singleagency.agency[0].subjects).slice(0, 2).map(i =>
...

                    {
                        singleAgency.loading ? <>
                            ...
                            singleAgency.singleagency.rating && singleAgency.singleagency.rating.length > 0 ? singleAgency.singleagency.rating.map(rate =>
                                <Review rate={rate} />) : ""
                    }
