...
export default function SignUp() {
    ...
    const userSignup = (e) => {
        ...
        // return false;
        axios.post('https://cybertizeweb.com/cms/studyfocus/cybertechMedia/api/new-study-api/register/tutor-api.php', formData)
    ...
    const councellorSignup = (e) => {
        ...
        console.log(formData);
        // return false;
        axios.post('https://cybertizeweb.com/cms/studyfocus/cybertechMedia/api/new-study-api/register/councellor-api.php', formData)
            .then(function (response) {
    ...
    const renderStep1 = () => {
        return (
            <>
                <div className="sign__input-wrapper mb-25">
                    ...
                    <div className="course__sort-inner">
                        <select value={type} onChange={(e) => { setType(e.target.value) }} style={{ width: '100%' }}>
                            ...
                            <option value='5'>Councellor</option>
                ...
                <button onClick={(e) => { setStep2('1'); setStep1('0') }} className="e-btn w-100">Continue Step 2</button>
            </>
        )
    }
    ...
    const renderStep2 = () => {
        return (
            <>
                ...
                <button onClick={e => { setStep3('1'); setStep2('0'); setStep2('0') }} className="e-btn w-100">Continue Step 3</button>
                    ...
                    <div className="row">
                        <div className="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                            <div className="sign__wrapper white-bg">
                                ...
                                {
                                    type == '5' ? renderCouncellor() : renderSignUp()
                                }
                            </div>
                        </div>
                    </div>
