...
export default function SignUp() {
    ...
    const [headtext, setHeadtext] = useState('Join As Tutor');
    ...
    const [description, setDescription] = useState('Teaching is my passion. Currently taking classes...');
    ...
    const userSignup = (e) => {
        ...
        // return false;
        axios.post('https://cms.cybertizeweb.com/studyfocus/cybertechMedia/api/new-study-api/register/tutor-api.php', formData)
        ...
        // } else if (type == 'tutor') {
        //     dispatch(signupTutor(user));
        //     setName('');

        // } else if (type == 'agency') {
        //     dispatch(signupAgency(user));
        // } else {
        //     alert('plz select type first...');
        // }
        setType('');
        setName('');
        setEmail('');
        ...
        return (
            <>
                ...
                <div className="sign__input-wrapper mb-25">
                    ...
                    {/* <div className="sign__input"> */}
                    <input type="file" name="file" accept="image/png, image/jpeg" onChange={changeHandler} />
                    {/* </div> */}
                </div>
    ...
    const renderStep2 = () => {
        return (
            <>
                ...
                <div className="sign__input-wrapper mb-25">
                    <h5>Select Subjects you teach
                    <p>Press Ctrl & Click to select multiple items</p>

                    </h5>
                    <Form.Group as={Col} controlId="multiselect_subject">
                        <Form.Control as="select" style={{height:'250px'}} multiple value={subject} onChange={e => setSubject([].slice.call(e.target.selectedOptions).map(item => item.value))}>
                            {
    ...
    const validateForm2 = (e) => {
        ...
        if(state == "" || scity == "" || cls == " " || subject == "" || medium == "" || board == ""){
            ...
            setStep2('0'); 
            setStep2('0');
            setHeadtext("Help Students know you better");
        }
    ...
    const renderStep3 = () => {
        return (
            <>
                ...
                <div className="sign__input-wrapper mb-25">
                    <h5>Select Online Platforms you teach (If Any)</h5>
                ...
                <div className="sign__input-wrapper mb-25">
                    <h5>Describe yourself in 150 words</h5>
                    <Form.Group as={Col} >
                        <Form.Control
                            as="textarea"
