...
import { getSingleCouncellor } from '../../../redux/actions';
...
export const MainDetail = () => {
    ...
    const { councellorsearch } = router.query;
    const dispatch = useDispatch();
    // const singleTutor = useSelector(state => state.singleTutorData);
    const singleCouncellor = useSelector(state => state.singleCouncellorData);
    ...
    const handleRating = () => {
        ...
        var councellor_id = singleCouncellor.singlecouncellor.councellor[0].id;
        // alert(councellor_id);
        // return;
        ...
        if (student.student_id == "") {
            ...
            const ratingData = {
                rating: rating, review: review, user_id: user_id, councellor_id: councellor_id
            }
            axios.post(`${api}/update/update-councellor-rating.php`, ratingData)
    ...
    const renderSubject = () => {
        renderSubArray(singleCouncellor.singlecouncellor.councellor[0].sector).length > 0 ?
            renderSubArray(singleCouncellor.singlecouncellor.councellor[0].sector).slice(0, 2).map(i =>
    ...
    useEffect(() => {
        if (councellorsearch != undefined) {
            const bslug = {
                councellor_slug: `${councellorsearch}`,
            }
            console.log(bslug);
            // return false;
            try {
                dispatch(getSingleCouncellor(bslug));
            } catch (e) {
                console.log(e);
            }
        }
                ...
                <div className="col-xxl-12">
                        ...
                        >
                            <div className="row">
                                <div className="col-md-3 col-xl-3">
                                    {
                                        singleCouncellor.singlecouncellor.councellor && singleCouncellor.singlecouncellor.councellor.length > 0 ? singleCouncellor.singlecouncellor.councellor.map(tutor =>
                                            <>
                                                <div style={{
                                                    height: '171px',
                                                    borderRadius: '23px',
                                                    ...
                                                    backgroundImage: `url(${generatePublicUrl('councellor/' + tutor.profile)})`
                                                }}></div>
                                            </>
                                        ) :
                                ...
                                <div className="col-md-9 col-xl-9">
                                    ...
                                    <p style={{ marginTop: '5px' }}>
                                        ...
                                        {singleCouncellor.singlecouncellor.city}, {singleCouncellor.singlecouncellor.state}
                    ...
                    <div className="card tutor-detail-card" >
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-md-9 col-xl-9">
                                    <p className="tutor-detail-heading">SECTORS WORKING</p>
...

                                    {
                                        singleCouncellor.loading ? <>
                                            ...
                                            singleCouncellor.singlecouncellor && singleCouncellor.singlecouncellor.councellor[0].sector.length > 0 ?
                                                renderSubArray(singleCouncellor.singlecouncellor.councellor[0].sector).slice(0, 2).map(i =>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-9 col-xl-9">
                                    ...
                                    <button className="btn" onClick={handleShow} style={{
                                        background: '#FFFFFF', border: '3px solid #4B47E8',
...

                    {
                        singleCouncellor.loading ? <>
                            ...
                            singleCouncellor.singlecouncellor.rating && singleCouncellor.singlecouncellor.rating.length > 0 ? singleCouncellor.singlecouncellor.rating.map(rate =>
                                <Review rate={rate} />) : ""
                    }
