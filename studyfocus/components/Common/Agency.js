                            ...
                            <div className="course__item white-bg mb-30 fix">
                                <div className="course__thumb w-img p-relative fix">
                                    <a href="course-details.html">
                                        <img width="216" height="129" src={generatePublicUrl('newtutor/' + agenc.profile)} alt="" />
                                    </a>
                                ...
                                <div className="course__content" style={{ height: '187px' }}>
                                    ...
                                    <div className="course__teacher d-flex align-items-center">
                                        <div className="course__teacher-thumb mr-15">
                                            <img src={generatePublicUrl('newtutor/' + agenc.profile)} alt="" />
                                        </div>
                                        <h6><a href="instructor-details.html">{agenc.name}</a></h6>
                                    </div>
                                </div>
