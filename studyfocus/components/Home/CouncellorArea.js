...
import { base_url_counc } from '../../helpers/urlConfig';
import Councellor from './Councellor'

export default function CouncellorArea() {
    ...
    const genLinkUrlSub = (subname) => {
        if (reduceCityData.reduceCity == "Select City") {
            return base_url_counc + 'India/' + subname;
        } else {
            return base_url_counc + `${reduceCityData.reduceCity}` + '/' + subname;
        }
    }
                ...
                <div className="row align-items-end">
                    <div className="col-xxl-5 col-xl-6 col-lg-6">
                        <div className="section__title-wrapper mb-60">
                            <h2 className="section__title">Find the Right<br /><span className="yellow-bg yellow-bg-big">Councellor<img
