                ...
                <div className="row align-items-end">
                    <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                        <div className="section__title-wrapper mb-45">
                            <h2 className="section__title">Explore <br />Our <span className="yellow-bg">Popular <img
                                src="assets/img/shape/yellow-bg-2.png" alt="" /> </span>Courses
                    </h2>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div className="category__item mb-30 transition-3 d-flex align-items-center">
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><a href="course-details.html">Data Science</a></h4>
                    ...
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div className="category__item mb-30 transition-3 d-flex align-items-center">
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><a href="course-details.html">Business</a></h4>
                    ...
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div className="category__item mb-30 transition-3 d-flex align-items-center">
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><a href="course-details.html">Art & Design</a></h4>
                                <p>Fun & Challenging</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div className="category__item mb-30 transition-3 d-flex align-items-center">
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><a href="course-details.html">Lifestyle</a></h4>
                    ...
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div className="category__item mb-30 transition-3 d-flex align-items-center">
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><a href="course-details.html">Marketing</a></h4>
                                <p>Improve your business</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div className="category__item mb-30 transition-3 d-flex align-items-center">
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><a href="course-details.html">Finance</a></h4>
                                <p>Fun & Challenging</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div className="category__item mb-30 transition-3 d-flex align-items-center">
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><a href="course-details.html">Health & Fitness</a></h4>
                    ...
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div className="category__item mb-30 transition-3 d-flex align-items-center">
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><a href="course-details.html">Music</a></h4>
                                <p>Major or Minor</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div className="category__item mb-30 transition-3 d-flex align-items-center">
                            ...
                            <div className="category__content">
                                <h4 className="category__title"><a href="course-details.html">Academics</a></h4>
