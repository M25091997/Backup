                    ...
                    <div className="row">
                        <div className="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3">
                            <div className="section__title-wrapper text-center mb-60">
                                <h2 className="section__title">We are <span className="yellow-bg yellow-bg-big">Proud<img
                    ...
                    <div className="row">
                        <div className="col-xxl-2 offset-xxl-1 col-xl-2 offset-xl-1 col-lg-3 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
                            <div className="counter__item mb-30">
                                ...
                                <div className="counter__content">
                                    <h4><span className="counter">345,421</span></h4>
                        ...
                        <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-5">
                            <div className="counter__item counter__pl-80 mb-30">
                                ...
                                <div className="counter__content">
                                    <h4><span className="counter">2,485</span></h4>
                                    <p>Total Courses</p>
                                </div>
                            </div>
                        </div>
                        <div
                            className="col-xxl-2 offset-xxl-0 col-xl-3 offset-xl-0 col-lg-3 offset-lg-0 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
                            <div className="counter__item counter__pl-34 mb-30">
                                    ...
                                    <svg viewBox="0 0 512 512">
                                        <g id="Page-1">
                                            <g id="_x30_01---Degree">
                                                ...
                                                <path id="Shape_1_" className="st0"
                                ...
                                <div className="counter__content">
                                    <h4><span className="counter">24,085</span></h4>
                                    <p>Online Learners</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-xxl-2 offset-xxl-1 col-xl-3 col-lg-3 col-md-3 col-sm-5">
                            <div className="counter__item mb-30">
                                ...
                                <div className="counter__content">
                                    <h4><span className="counter">203</span>k</h4>
