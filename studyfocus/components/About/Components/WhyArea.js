                        ...
                        <div className="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-6 col-md-8">
                            <div className="why__content pr-50 mt-40">
                                <div className="section__title-wrapper mb-30">
                                    ...
                                    <h2 className="section__title">Tools for <span className="yellow-bg yellow-bg-big">Teachers<img
                            ...
                            Charles bonnet arse at public school bamboozled.</p>
                                ...
                                <div className="why__btn">
                                    <a href="contact.html" className="e-btn e-btn-3 mr-30">Join for Free</a>
