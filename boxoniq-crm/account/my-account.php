...
<html lang="en">
<head>
  <title>Create Account :: <?php echo $the_project; ?></title>
  <meta charset="UTF-8">
...
<br> 
  ...
  <li class="list-group-item d-flex justify-content-between align-items-center">
    <a href="<?php echo $site_url; ?>/account/my-orders"> Orders </a>
    
  </li>
  <li class="list-group-item d-flex justify-content-between align-items-center">
    <a href="<?php echo $site_url; ?>/account/my-favourites"> Favourites </a>
    
  </li>

  <li class="list-group-item d-flex justify-content-between align-items-center">
    <a href="<?php echo $site_url; ?>/logout" style="color: red;" > Logout </a>
  </li>
