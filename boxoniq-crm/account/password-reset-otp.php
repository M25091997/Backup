...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form otp-form" action="<?php echo $site_url; ?>/api/verify-reset-otp.php">
...
<script type="text/javascript">
  ...
  success: function(login_json) {
   ...
   jQuery(login_json).each(function(i, object){
  	...
  	if (object.response == "1") { window.location.href="new-password.php"; }
