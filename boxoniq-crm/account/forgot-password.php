...
<html lang="en">
<head>
	<title>Reset Password :: <?php echo $the_project; ?></title>
	<meta charset="UTF-8">
...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form reset-form" action="<?php echo $site_url; ?>/api/reset-password.php">
					...
					<div class="wrap-input100 validate-input" data-validate = "Mobile Number">
						...
						<input class="input100" type="text" name="mobile" placeholder="Enter 10 Digit Mobile.">
...
<script type="text/javascript">
  ...
  success: function(login_json) {
   ...
   jQuery(login_json).each(function(i, object){
  	...
  	if (object.response == "1") { window.location.href="password-reset-otp.php"; }
  	else if (object.response == "333") { alert("Sorry, no accounts found associated to this number."); }
