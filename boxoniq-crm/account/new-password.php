...
<html lang="en">
<head>
	<title>Create Passsword :: <?php echo $the_project; ?></title>
	<meta charset="UTF-8">
...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form otp-form" action="<?php echo $site_url; ?>/api/update-password.php">
...
<script type="text/javascript">
  ...
  success: function(login_json) {
   ...
   jQuery(login_json).each(function(i, object){
  	...
  	if (object.response == "1") { alert("Your Password has been reset successfully!\nLogin to continue"); window.location.href="login.php"; }
  	else if (object.response == "333") { alert("Otp Mismatched!"); }
