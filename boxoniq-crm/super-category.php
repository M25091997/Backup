...
$slug = $_GET['slug'];
$QC = $conn -> query("SELECT * FROM super_category WHERE slug = '$slug'");
...
$Q = $conn -> query("SELECT * FROM items WHERE category_id = '$category_id'");
...
$SQ = $conn -> query("SELECT * FROM super_category LIMIT 18");
            ...
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    ...
                    <?php } ?>
                        ...
                        <div class="sidebar__item">
                            <h4>Top Brands</h4>
                            <ul>
                    <?php $subQ = $conn -> query("SELECT * FROM brand LIMIT 200"); 
                    while ($subData = mysqli_fetch_array($subQ)) { ?>
                        <li><a href="<?php $site_url; ?>/Brand/<?php echo $subData['slug'] ?>" class="brand-item" style="font-size: 14px;     margin-top: -20px;"><?php echo $subData['name'] ?> <i class="fa fa-long-arrow-right" style="float: right;"></i></a></li>
                    <?php } ?>
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                        ...
                        $Q = $conn -> query("SELECT * FROM items WHERE category_id = '$category_id' ORDER BY id DESC LIMIT 350 ");
