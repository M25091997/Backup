...
<link rel="stylesheet" href="//code.jquery.com/ui/1.13.1/themes/base/jquery-ui.css">
  ...
  <body style="background-color: #fff;">
    ...
    <div class="container-fluid" style="background-color: #fff;">
      ...
      <div class="row">
        <center>
          <h2>Sales Report (Subscription)</h2> <a target="_empty" href="export-excel/export-all-order.php" class="btn btn-success" title="Click to export"><i class="dwn"></i> Export</a>
        </center>
        <center>
