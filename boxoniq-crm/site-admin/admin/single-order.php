...
?>
  ...
  <body style="background-color: #fff;">
    ...
    <div class="container-fluid" style="background-color: #fff;">
      ...
      <div class="row">
        <center>
          <h2>Single Order</h2> <a target="_empty" href="export-excel/export-all-order.php" class="btn btn-success" title="Click to export"><i class="dwn"></i> Export</a>
        </center>
      </div>
      ...
      <div class="row">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <?php 
            $process_id = $_GET['order_id'];
            $cQ = $conn->query("SELECT * FROM bookings WHERE subscription = '0' && process_id = '$process_id' ORDER BY id DESC ");
