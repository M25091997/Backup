...
?>
    ...
    <body style="background-color: #fff;">
        ...
        <div class="container-fluid" style="background-color: #fff;">
            ...
            <div class="row">
                <center>
                    <h2>All Subscription Orders</h2> <a target="_empty" href="export-excel/export-all-subscription-order.php" class="btn btn-success" title="Click to export"><i class="dwn"></i> Export</a>
                </center>
            </div>
            ...
            <div class="row">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php $cQ = $conn->query("SELECT * FROM subs_booking_history ORDER BY id DESC ");
                        ...
                        while ($rowD = mysqli_fetch_array($cQ)) {
                            ...
                            $TRANSACTION_ID = $rowD['payment_transaction_id'];
                            ...
                            $aQ = $conn->query("SELECT * FROM saved_address WHERE id = '$address_id'");
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td> <?php echo $account_name; ?> <br> <a href="<?php echo $site_url; ?>/billing-subscription/?id=<?php echo $process_id; ?>" target="_blank">View Bill <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a> <br> BID: <?php echo "CTIND" . substr($process_id, 0, 8); ?></td>

                                <td> <?php echo $account_phone; ?> <br> <?php echo $account_email; ?> </td>

                                <td> <?php echo $address; ?> <br> <b>Landmark:</b> <?php echo $landmark ?> <br> <b>Pincode:</b> <?php echo $pincode ?> </td>
                                ...
                                <td>
                                    ...
                                    $aQzz = $conn->query("SELECT * FROM subs_order_history WHERE process_id = '$process_id'");
                                    while ($sD = mysqli_fetch_array($aQzz)) {
                                        $sub_cart_id = $sD['sub_cart_id'];

                                        $aQz = $conn->query("SELECT * FROM subs_cart_history WHERE id = '$sub_cart_id'");
                                        while ($sD = mysqli_fetch_array($aQz)) {
                                            $product_id = $sD['item_id'];
                                            $attribute_id = $sD['attr_id'];
                                            $quantity = $sD['item_qty'];
                                            $price = $sD['attr_price'];
                                            $xamount = $price * $quantity;
                                        ...
                                        $(".x-action-<?php echo $order_id; ?>").change(function() {
                                            if (confirm("Change Order Status?")) {
                                                ...
                                                if ($(".x-action-<?php echo $order_id; ?>").val() == "5") {
                                                    ...
                                                    if (promt != null) {
                                                        window.location.href = "cancel-subs-order.php?order-id=<?php echo $order_id; ?>&reason=" + promt + '&by=ADMIN';
                                                    }

                                                } else if ($(".x-action-<?php echo $order_id; ?>").val() == "1001") {
                                                    ...
                                                    window.location.href = "change-subs-order-status.php?order-id=<?php echo $order_id; ?>&status-id=" + $(".x-action-<?php echo $order_id; ?>").val();
                                                }
