...
<link rel="stylesheet" href="//code.jquery.com/ui/1.13.1/themes/base/jquery-ui.css">
  ...
  <body style="background-color: #fff;">
    ...
    <div class="container-fluid" style="background-color: #fff;">
      ...
      <div class="row">
        <center>
          <h2>Sales Report (Normal)</h2> <a target="_empty" href="export-excel/export-all-order.php" class="btn btn-success" title="Click to export"><i class="dwn"></i> Export</a>
        </center>
        <center>
                <label for="from">From</label>
                <input type="text" id="from" value="<?php echo $_GET['start_date'] ?>" name="from" placeholder="Enter Start Date">
                <label for="to">to</label>
                <input type="text" id="to" name="to" value="<?php echo $_GET['end_date'] ?>" placeholder="Enter End Date">
                <button class="btn btn-primary" id="filter_date">Submit</button>
      </center>
      ...
      <div class="row">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            if($start_dt != "" && $end_dt != ""){
            $cQ = $conn->query("SELECT * FROM bookings WHERE subscription = '0' && order_status = 4 && creation_date >= '$start_dt' && $end_dt <= '$end_dt' ORDER BY id DESC ");
            }else{
            $cQ = $conn->query("SELECT * FROM bookings WHERE subscription = '0' && order_status = 4 ORDER BY id DESC ");
            }
            ...
            ?>
              ...
              <tr>
                ...
                <td> <?php echo $account_name; ?> <br> <a href="<?php echo $site_url; ?>/billing-desk/?id=<?php echo $process_id; ?>" target="_blank">View Bill <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a> <br> BID: <?php echo "CTIND" . substr($process_id, 0, 8); ?> <br> <?php echo $account_phone; ?> <br> <?php echo $account_email; ?></td>

                <td> <?php echo $address; ?> <br> <b>Landmark:</b> <?php echo $landmark ?><br> <b>Pincode:</b> <?php echo $pincode ?><br><?php echo $start_dt ?><br><?php echo $end_dt ?><br>  </td>
...
<script>
  $('#filter_date').click(() => {
      ...
      if(to != '' && from != ''){
        window.location.href = 'sales-report-normal.php?start_date=' + from + '&end_date='+to;
      }
