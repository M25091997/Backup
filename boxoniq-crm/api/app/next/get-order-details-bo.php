...
if (isset($process_id)) {
  ...
  $total = array('subtotal' => $stotal, 'discount' => $discount, 'status' => $order_status, 'delivery' => $delivery, 'coupon' => $coupon_amount, 'total' => $new_total - $bundal_discount, 'bundle_discount' => $bundal_discount);
