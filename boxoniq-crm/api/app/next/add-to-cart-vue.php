...
// $account_temp_id = $data['account_temp_id'];
$mrp = $product_price;

// if($account_id == null){
//     $account_id = $account_temp_id;
// }


if (isset($account_id)) {

    $get_attr = $conn -> query("SELECT * FROM attributes WHERE item_id = '$product_id' && price = '$product_price' ORDER BY id ASC LIMIT 1 ");
