...
$get_answer_count = $conn -> query("SELECT * FROM community_answer WHERE question_id = '$question_id' ");
...
// $answer_count = 5;
	...
	array_push($result, array('response' => '1', 'answer_id' => $id, 'answer' => $answer, 'user_name' => $user_name, 'img' => $user_img, 'created_on' => $created_on ));
