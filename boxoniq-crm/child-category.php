...
$slug = $_GET['slug'];
$QC = $conn -> query("SELECT * FROM category_2 WHERE slug = '$slug'");
            ...
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        <div class="sidebar__item">
                            <h4>Explore</h4>
                            <ul>
                    <?php $subQ = $conn -> query("SELECT * FROM super_category"); 
                    while ($subData = mysqli_fetch_array($subQ)) { ?>
                        <li><a href="<?php $site_url; ?>/Category/<?php echo $subData['slug']; ?>"><?php echo $subData['name'] ?></a></li>
                    <?php } ?>
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                        ...
                        $Q = $conn -> query("SELECT * FROM items WHERE category_2_id = '$category_id' ORDER BY id DESC LIMIT 350 ");
