...
$slug = $_GET['slug'];
$QC = $conn -> query("SELECT * FROM brand WHERE slug = '$slug'");
...
$Q = $conn -> query("SELECT * FROM items WHERE brand_id = '$category_id'");
$total = mysqli_num_rows($Q);

?>

    <!-- Breadcrumb Section Begin -->
    <section class="breadcrumb-section set-bg" data-setbg="<?php echo $site_url; ?>/img/breadcrumb.jpg">
        <div class="container">
            <div class="row">
...
$SQ = $conn -> query("SELECT * FROM super_category LIMIT 16");

while ( $listD = mysqli_fetch_array($SQ)) { 

    if ( $listD['slug'] == $_GET['slug'] ) { $c = "#7fad39;"; $font = "#fff;"; } else { $c = "#fff;"; $font = "#000;"; }

    ?>
    <li><a href="<?php echo $site_url; ?>/Category/<?php echo $listD['slug']; ?>" class="btn btn-primary" style="border-radius: 25px; background-color: #fff; border-color: #215273; background-color: <?php echo $c; ?> color: <?php echo $font; ?> margin-top: 2px; font-size: 12px;"><?php echo $listD['name']; ?></a></li>
<?php } ?>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        <div class="sidebar__item" style="display: none;">
                            ...
                            <ul>
                    <?php $subQ = $conn -> query("SELECT * FROM category WHERE super_category_id = '$category_id'"); 
                    ...
                    <?php } ?>
                        ...
                        <div class="sidebar__item">
                            <h4>Top Brands</h4>
                            <ul>
                    <?php $subQ = $conn -> query("SELECT * FROM brand LIMIT 50"); 
                    while ($subData = mysqli_fetch_array($subQ)) { ?>
                        <li><a href="<?php $site_url; ?>/Brand/<?php echo $subData['slug'] ?>" class="brand-item" style="font-size: 14px;     margin-top: -18px;"><?php echo $subData['name'] ?> <i class="fa fa-long-arrow-right" style="float: right;"></i></a></li>
                    <?php } ?>
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                        ...
                        $Q = $conn -> query("SELECT * FROM items WHERE brand_id = '$category_id' ORDER BY id DESC LIMIT 50 ");
