  ...
  <body>
    <header class="clearfix">
      ...
      <div id="company">
        ...
        $cQ = $conn -> query("SELECT * FROM subs_booking_history WHERE process_id = '$booking_id' ORDER BY id DESC "); 
...
<?php 
      ...
      <?php $item_list_x ++; }  
        ...
        $subs_discount = round($TOTAL_MRP * 5/100);
        $bundle_discount = 0;
        $coupon_discount = 0;
      ...
      ?>
        ...
        <tfoot>
          ...
          <tr><td></td>
            <td colspan="2" class="no-border"></td>
            <td colspan="4">SUBSCRIPTION DISCOUNT</td>
            <td> - <i class="fa fa-inr"></i> <?php echo $subs_discount; ?>.00</td>
          </tr>
          <tr><td></td>
            <td colspan="2" class="no-border"></td>
            <td colspan="4">BUNDLE DISCOUNT</td>
            <td> - <i class="fa fa-inr"></i> <?php echo $bundle_discount; ?>.00</td>
          </tr>
          <tr><td></td>
            <td colspan="2" class="no-border"></td>
            <td colspan="4">COUPON DISCOUNT</td>
            <td> - <i class="fa fa-inr"></i> <?php echo $coupon_discount; ?>.00</td>
          </tr>
         ...
         <?php }
          ...
          <tr><td></td>
            <td colspan="2" class="no-border"></td>
            <td colspan="4" style="color:#000; font-weight: bold;">GRAND TOTAL</td>
            <td style="color:#000; font-weight: bolder;"><i class="fa fa-inr"></i> <?php echo ($TOTAL_MRP + $del_charge - $subs_discount - $bundle_discount - $coupon_discount)  ; ?>.00</td>
          </tr>
        </tfoot>
      </table>
