...
try { #try 1
    ...
    // if($execution_flag) {
        ...
        // if($coins_redeemed > 0) {
        //    RedeemCoin( $account_id, $coins_redeemed, $booking_id);
        // }
        // if($amount<=0) {

        //     $coin_earned = coins_to_be_given($coins_redeemed);

        //     // GiveCoins( $account_id, $coin_earned, $booking_id);
        //     AllotCoins( $account_id, $coin_earned, $booking_id);

        // }else{

        //     $coin_earned = coins_to_be_given($amount);
