...
$msg_query_T = $conn -> query("SELECT * FROM items WHERE sub_category_id = '$id'");
...
$msg_query = $conn -> query("SELECT * FROM items WHERE sub_category_id = '$category_id' ORDER BY id DESC");
