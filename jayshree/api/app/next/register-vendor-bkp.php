...
try {
        ...
        $stmt = $conn_P -> prepare("INSERT INTO vendor (email, address, city, state, pincode, landmark, phone, fax, web, title, email2, contact, company, associate, busstype, bussnature, listproduct, year, numemp, fssai, pan, gst, country, turnover1, turnover2, turnover3, profit1, profit2, profit3, cus1, cus2, cus3, cus4, cus5, value1, value2, value3, value4, value5, year1, year2, year3, year4, year5, goods1, goods2, goods3, goods4, goods5, ctr1, ctr2, ctr3, ctr4, ctr5, comp1, comp2, comp3, cont1, cont2, cont3, pos1, pos2, pos3, contemail1, contemail2, contemail3, contphone1, contphone2, contphone3, description) VALUES (:email, :address, :city, :state, :pincode, :landmark, :phone, :fax, :web, :title, :email2, :contact, :company, :associate, :busstype, :bussnature, :listproduct, :year, :numemp, :fssai, :pan, :gst, :country, :turnover1, :turnover2, :turnover3, :profit1, :profit2, :profit3, :cus1, :cus2, :cus3, :cus4, :cus5, :value1, :value2, :value3, :value4, :value5, :year1, :year2, :year3, :year4, :year5, :goods1, :goods2, :goods3, :goods4, :goods5, :ctr1, :ctr2, :ctr3, :ctr4, :ctr5, :comp1, :comp2, :comp3, :cont1, :cont2, :cont3, :pos1, :pos2, :pos3, :contemail1, :contemail2, :contemail3, :contphone1, :contphone2, :contphone3, :description)");
