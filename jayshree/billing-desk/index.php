  ...
  <body>
    <header class="clearfix">
      ...
      <div id="company">
        ...
        <div>157 A ZONE 4, <br>BIRSANAGAR, JAMSHEDPUR - 831004, <br>
        </div>
        <!-- <div>GST: 20ANLPN8822H1ZY</div> -->
        <div>(+91) 8917595065</div>
        <div>(+91) 9973802955</div>

        <div><a href="mailto:connect@kumbaya.in">connect@kumbaya.in</a></div>
      </div>
      </div>
    </header>
        ...
        $cQ = $conn -> query("SELECT * FROM bookings WHERE id = '$booking_id' ORDER BY id DESC "); 
...
// **********************************************************************************************
    ...
    <main>
      <div id="details" class="clearfix">
        ...
        <div id="invoice">
          <h1><?php echo $payment_status_name; ?> INVOICE #<?php echo $order_id; ?></h1>
...
<?php 
          ...
          <tr>
            ...
            <td class="unit"> <center> <i class="fa fa-inr"></i> <?php echo $attr_price; ?>.00</center></td>
      ...
      <?php $item_list_x ++; }  ?>
        ...
        <tfoot>
         ...
         <?php }
          ...
          <tr><td></td>
            <td colspan="2" class="no-border"></td>
            <td colspan="2" style="color:#000; font-weight: bold;">GRAND TOTAL</td>
