  ...
  $(".update-p-btn-<?php echo $id; ?>").click(function(r){
    ...
    if ( parseInt($("[name=pin-<?php echo $id; ?>]").val()) == 834006 ) {
      ...
      $("[name=pin-<?php echo $id; ?>]").val( parseInt( parseInt($("[name=pin-<?php echo $id; ?>]").val()) + 1) );
           ...
           <td>
             <button type="button" class="btn btn-primary btn-small btn-xs btn-mini input-xs update-btn-<?php echo $id; ?>"><i class="fa fa-edit"></i> Update</button> <button type="button" class="btn btn-danger btn-small btn-xs btn-mini input-xs attr-deleter" attr-id="<?php echo $id; ?>"> <i class="fa fa-trash"></i> Delete</button> 
