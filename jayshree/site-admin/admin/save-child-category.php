...
try { #try 1
    ...
    $stmt = $conn_pdo -> prepare("INSERT INTO category_2 ( name, slug, category_1_id ) VALUES ( :name, :slug, :super_category_id )");
    ...
    $super_category_id = slugify($_POST['category_1_id']);

    $execution_flag = $stmt -> execute(); // Executing the query

    if ($execution_flag) { header("Location: new-sub-category-2.php"); }
