...
?>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          ...
          <div>
            ...
            <form action="delivery-boy-img.php" class="dropzone d2 col-md-12 x-magic-form" style="background-color:#fff; border: none; border: 1px dashed #ccc; border-radius: 10px; width: 100%;margin-bottom:20px;">
          ...
          <form action="action/save-delivery-boy.php" method="POST" enctype="multipart/form-data">
            <h3>Name</h3>
            <input type="text" name="name" placeholder="Full name" class="form-control" required>
            <hr>

            <input type="hidden" name="media_no" class="form-control" value="<?php echo $media_number; ?>" required>
            <hr>

            <h3>Mobile No</h3>
            <input type="text" name="contact" id="contact" placeholder="Enter Mobile No" class="form-control" required>
            <hr>
        ...
        <div class="col-md-7">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <?php $msg_query = $conn->query("SELECT * FROM delivery_boy ORDER BY id DESC");
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info" target="_empty" href="view_order.php?delivery_partner_id=<?php echo $id ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                  </td>
                  ...
                  <td>
                    ...
                    <button class="btn btn-danger delete_del_boy" del_delete_id=<?php echo $id ?>><i class="fa fa-trash" aria-hidden="true"></i></button>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".delete_del_boy").click(function() {
        var del_delete_id = $(this).attr('del_delete_id');
        // alert(del_delete_id);
        $.ajax({
          url: "action/delete_delivery_boy.php",
          method: "POST",
          data: {
            deleteDelBoy: 1,
