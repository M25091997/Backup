...
<div class="container" style="background-color: #fff;">
 ...
 <option value="<?php echo $sData['id']; ?> "><?php echo $sData['name']; ?> </option>
  ...
  <li class="list-group-item"><?php echo $sData['name']; ?> <small style="color: #7d7d7d;">(in <?php echo $name_m; ?>)</small> <a href="delete-sub-category.php?id=<?php echo $sData['id']; ?>" style="float: right;"><i class="fa fa-trash"></i></a></li>
