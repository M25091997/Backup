...
<div class="row">
	...
	<form class="save-product-form" action="save-gcm.php" method="post">
	...
	<h3 class="text-left"><center>NOTIFICATION SHOOTER</center></h3>
	...
	<h3 class="text-left">Notification Title <input type="submit" class="btn btn-info btn-xs btn-mini" style="display: inline;" name="submit" value="Shoot Notification" /></h3>
...
<br>
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <input class="form-control p-title intent-id" name="intent-id" placeholder="SUB, SUPER, ITEM ID" value="" required></input>
...
<div  style="height: 347px;
  ...
  while ($row = mysqli_fetch_array($q)) {
    ...
    $phone = $row['phone']; ?>
        ...
        <td><input type="checkbox" firebase="<?php echo $row['firebase_token']; ?>" value="<?php echo $id; ?>" id="<?php echo $id; ?>" class="chk"></td>
