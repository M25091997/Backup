...
<div class="container" style="background-color: #fff;">
  ...
  while ($row = mysqli_fetch_array($q)) {
    ...
    <input type="text" name="price" placeholder="Actual Price in Rs." class="form-control" required> <br>
    ...
    <h3>MRP</h3>
    <input type="text" name="mrp" placeholder="Current Market Rate" class="form-control" required> <br>


    <h3>Discount</h3>
    <input type="text" name="discount" placeholder="discount you are providing" class="form-control" required> <br>
