...
try { #try 1
    ...
    $stmt = $conn_pdo -> prepare("INSERT INTO attributes ( name, item_id, slug, price, availablity, mrp, discount, media_number, stock, expiry_date ) VALUES ( :name, :item_id, :slug, :price, :availablity, :mrp, :discount, :media_number, :stock,  :expiry_date )");
