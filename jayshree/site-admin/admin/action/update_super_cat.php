...
if (isset($_POST["updateSuperCat"])) {
  ...
  $sql = "UPDATE super_category set name = '$name', media_number = '$media_number_edit', banner_number = '$cat_banner_edit' WHERE id = '$update_id'";

  $run_query = mysqli_query($conn, $sql);

  if ($run_query) {
    header("Location: ../new-main-category.php");
  }
}
