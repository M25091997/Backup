          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                ...
                if ($media_number != '') {
                  $p_sql = "SELECT * FROM media WHERE media_number ='$media_number'";
                  $p_query = mysqli_query($conn, $p_sql);
                  $pcount = mysqli_num_rows($p_query);
                  if ($pcount > 0) {
                    $p_row = mysqli_fetch_assoc($p_query);
                    $p_filename = $p_row['file_name'];
                  } else {
                    $p_filename = "";
                  }
                }
                ...
                ?>
                <!-- <td><?php echo $p_filename; ?></td> -->
                <td>
                  <center>
                    <a href="../../media/<?php echo $p_filename; ?>" target="_blank">
                      <img src="../../media/<?php echo $p_filename; ?>" width="50" height="50">
                    </a>
                </td>
                </center>
