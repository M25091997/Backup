...
?>
  ...
  <head>
    ...
    <title>Manage Corporate Category</title>
        ...
        <div class="col-md-12">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <?php $msg_query = $conn->query("SELECT * FROM corporate_category");
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <button class="btn btn-danger delete_corporate" corporate_delete_id=<?php echo $id ?>><i class="fa fa-trash" aria-hidden="true"></i></button>
                  </td>
                </tr>
              <?php } ?>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".delete_corporate").click(function() {
        var corporate_delete_id = $(this).attr('corporate_delete_id');
        // alert(corporate_delete_id);
        $.ajax({
          url: "action/delete_category.php",
          method: "POST",
          data: {
            deleteCorporate: 1,
            del_id: corporate_delete_id
          },
          dataType: "json",
          success: function(data) {
            if (data.response == 1) {
...
toggle between hiding and showing the dropdown content */
    ...
    // return;
     $.ajax({
                ...
                method:"POST",
                data:{updateCorporateCategoryPriority:1,prior_id:prior_id, corporate_category_id:set_category_id},
                // dataType:"json",
                success:function(data){
                    alert(data);
                }
