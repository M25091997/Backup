...
<script type="text/javascript">
  ...
  <form action="img-parse-cat-banner.php" class="dropzone d3 col-md-12 x-magic-form" style="background-color:#fff; border: none; border: 1px dashed #ccc; border-radius: 10px; width: 100%;">
...
<script type="text/javascript">
  ...
  <li class="list-group-item">#<b><?php echo $sData['id']; ?></b>. <?php echo $sData['name']; ?> <a data-toggle="modal" data-target="#exampleModal"><i class="fa fa-edit edit_del_boy" cat_edit_id=<?php echo $sData['id'] ?>></i></a>|<a href="delete-super-category.php?id=<?php echo $sData['id']; ?>" style="float: right;"><i class="fa fa-trash"></i></a></li>
