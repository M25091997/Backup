    ...
    <div class="container" style="background-color: #fff;">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <form action="action/save-product.php" method="POST">
            <input type="hidden" class="media_number" id="media_number_pro" name="media-number-p"></input>
            ...
            <input type="text" name="hindi_name" placeholder="Product Full name" class="form-control" required> <br>
            ...
            <select class="form-control corporate-category" name="corporate_id">
              ...
              while ($sData = mysqli_fetch_array($cor_query)) { ?>
            ...
            <input type="text" name="attr_name" placeholder="Enter Attribute Name" class="form-control" required>
            <hr>

            <h3>Price</h3>
            <input type="text" name="pro_price" placeholder="Enter Price" class="form-control" required>
            <hr>

            <h3>MRP</h3>
            <input type="text" name="pro_mrp" placeholder="Enter MRP" class="form-control" required>
            <hr>

            <h3>Discount</h3>
            <input type="text" name="pro_discount" placeholder="Enter Discount" class="form-control" required>
            <hr>

            <h3>Stock</h3>
            <input type="text" name="pro_stock" placeholder="Enter Stock" class="form-control" required>
            <hr>

            <h3>Description</h3>
            <textarea name="description" placeholder="Product Desctiption" class="form-control" required></textarea>
            <hr>
...
<br> -->
  ...
  <script type="text/javascript">
    ...
    // corporate category start

    $(".corporate-category").on('change', function() {
      $(".sub-category-holder").html("<option>Please Wait...</option>");
